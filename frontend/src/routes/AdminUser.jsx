...
export default function AdminUsers() {
  ...
  return (
    <>
      <NavBar />
      {/* Main container: added class + removed light background */}
      <div 
      ...
      >
        ...
        {showForm && (
          <div
            ...
            style={{
              background: '#ffffff', // light default; dark mode can override via CSS if needed
              padding: '24px',
              borderRadius: '12px',
        ...
        {loading ? (
          ...
          <div style={{ overflowX: 'auto' }}>
            {/* Table: removed white background, light header, and shadow */}
                    ...
                    <tr key={user._id}>
                      ...
                      <td style={{ padding: '14px', textAlign: 'center' }}>
                        ...
                        <button
                          ...
                          style={{
                            padding: '6px 14px',
                            backgroundColor: isCurrentUser ? '#999' : '#ff4d4f',
                            color: 'white',
                            border: 'none',
                            borderRadius: '4px',
